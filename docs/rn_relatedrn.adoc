...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3362264["NetApp Element 소프트웨어 12.9 릴리스 노트"^]_새로운_
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3344864["vCenter 플러그인 5.5 릴리스 노트"^]
...
* link:rn_compute_firmware_2.179.0.html["Compute Firmware Bundle 2.179.0 릴리스 정보"]
...
* link:rn_storage_firmware_2.182.0.html["스토리지 펌웨어 번들 2.182.0 릴리스 정보"]
