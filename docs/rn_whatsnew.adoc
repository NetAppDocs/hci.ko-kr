...
NOTE: Element 소프트웨어 12.9는 최신 릴리스로, 보안 및 시스템 구성 요소 업데이트, 운영 개선 사항, 해결된 문제가 포함되어 있습니다. https://docs.netapp.com/us-en/element-software/concepts/concept_rn_whats_new_element.html["Element 12.9의 새로운 기능에 대해 자세히 알아보세요"^] .
