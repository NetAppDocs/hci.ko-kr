...
.단계
. 스토리지 업그레이드 패키지를 다운로드합니다. NetApp HCI 시스템의 경우 NetApp HCI 소프트웨어로 이동하십시오 https://mysupport.netapp.com/site/products/all/details/netapp-hci/downloads-tab["다운로드 페이지"^] 최신 스토리지 노드 이미지를 관리 노드가 아닌 디바이스로 다운로드합니다.
+
...
.무엇을 &#8217;필요로 할거야
. NetApp HCI 시스템의 경우 NetApp HCI 소프트웨어로 이동하십시오 https://mysupport.netapp.com/site/products/all/details/netapp-hci/downloads-tab["다운로드 페이지"^].
